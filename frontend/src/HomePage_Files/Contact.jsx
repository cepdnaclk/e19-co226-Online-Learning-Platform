...
export default function Contact() {
    ...
    const handleSubmit = (event) => {
        ...
        // Handle form submission logic here (e.g., send form data to a backend server)
            ...
            <div className='pb-20 p-5 select-none'>
                <div className="mx-auto max-w-screen-md">
                    ...
                    <form action="#" className="space-y-6">
                        ...
                        <button type="submit"
                            className="text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-2 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">
                            Submit
                        </button>
                    </form>
                </div>
