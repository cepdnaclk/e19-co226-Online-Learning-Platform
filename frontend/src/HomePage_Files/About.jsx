        ...
        <>
            ...
            <div className='px-10 pt-6 pb-20 select-none'>
                ...
                <p className='text-center text-xl '>
                    Welcome to our online course offering platform, a dynamic virtual space where learning knows no boundaries.
                    We are passionate about empowering individuals from all walks of life to pursue their dreams, expand their horizons,
                    and acquire valuable skills. Just like the world-renowned platform Coursera, we strive to create an inclusive learning
                    ...
                    extend beyond the virtual classroom. Join us on this educational journey, where knowledge knows no boundaries
                    and the possibilities for personal and professional growth are limitless. Together, let's embrace the
                    transformative power of learning and shape a brighter future, one course at a time.
                </p>
